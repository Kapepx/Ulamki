...
//public:
    ...
    long long GetWholes();
    double GetNumAsDbl() const;
    double GetDenomAsDbl() const;
    Fraction GetNumAsFrac() const;
    ...
    void GetTrueValues(double *num, double *denom) const;
    Fraction operator = (const double val);
